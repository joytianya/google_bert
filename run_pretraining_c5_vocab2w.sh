...
INPUT_DIR=gs://clue_pretrain_corpus/tfrecords/bert_base_128_c5_vocab2w/clue_pretrain128_*.tfrecord
OUTPUT_DIR=gs://clue_pretrain_corpus/experiments/bert_base_128_c5_vcoab2w_3g/$CURRENT_TIME
IP=10.240.1.26

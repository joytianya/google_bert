...
CLUE_PREV_TRAINED_MODEL_DIR=gs://clue_pretrain_corpus/experiments # 模型文件 no change
...
run_task tnews bert_base_c5_vocab8k_1g_375k 128 16 2e-5 3 300 10.240.1.10 #
# run_task iflytek bert_base_c5_vocab8k_1g_375k 128 32 2e-5 3 300 10.240.1.18
# run_task cmnli bert_base_c5_vocab8k_1g_375k 128 64 3e-5 2 300 10.240.1.18

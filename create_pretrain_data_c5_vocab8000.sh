...
do
  ...
  python3 create_pretraining_data.py  --input_file=gs://clue_pretrain_corpus/raw_txt_corpus/train/clue_pretrain_$l.txt \
    --output_file=gs://clue_pretrain_corpus/tfrecords/bert_base_128_vocab8k/clue_pretrain128_$i.tfrecord --vocab_file=./bert_base_dir/chinese_L-12_H-768_A-12/vocab_clue.txt \

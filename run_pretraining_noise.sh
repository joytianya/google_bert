...
OUTPUT_DIR=gs://models_zxw/fine_tuning_models/nlp/bert_zh_clue_corpus/len_128_noise/$CURRENT_TIME
IP=10.100.247.82
nohup python3 run_pretraining_noise.py \
  ...
  --learning_rate=1e-4  \
  --save_checkpoints_steps=1000 > bert_clue_noise.out &
